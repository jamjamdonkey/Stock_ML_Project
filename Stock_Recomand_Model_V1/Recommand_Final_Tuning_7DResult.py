...
learn_path = os.path.join(BASE_DIR, "Learn_7D.csv")  # ✅ 파일명 변경
input_path = os.path.join(BASE_DIR, "Input_7D.csv")
output_path = os.path.join(BASE_DIR, "Top10_Recommanded_7D.csv")
...
# [2] 피처 및 타겟 정의
drop_cols = ['날짜', '종목코드', '종가', 'target', 'future_return_7d']  # ✅ 미래수익률 컬럼 변경
...
print("\nTop10_Recommanded_7D.csv 저장 완료 (SHAP 상위 피처 + 종목명 포함)")
